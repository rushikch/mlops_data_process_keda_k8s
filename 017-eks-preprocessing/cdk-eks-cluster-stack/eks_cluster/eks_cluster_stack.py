...
class EksClusterStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, app_prefix: str, network_stack, **kwargs) -> None:
        ...
        # Add S3 bucket for storing data preprocessing results
        self.__create_s3_buckets(app_prefix=app_prefix)
    ...
    def __create_iam_roles(self, app_prefix: str) -> None:
        ...
        self.data_preprocessing_role = iam.Role(
            ...
            managed_policies=[
                iam.ManagedPolicy.from_aws_managed_policy_name("AmazonS3FullAccess"), # Full access to S3 buckets for testing purposes
